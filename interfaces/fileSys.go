...
type FileSysInfo interface {
	...
	GetFsProviderSum(fsAddr common.Address, uIndex uint64) (pSum uint64, err error)
	GetFsProvider(fsAddr common.Address, uIndex uint64, index uint64) (pIndex uint64, err error)
